...
#define kMainPageAlpha    0.4   //中视图的透明度
...
#define kLeftAlpha  0.3//0.9  //左侧蒙版的最大值
#define kLeftCenterX  0//30 //左侧初始偏移量
#define kLeftScale  1//0.7 //左侧初始缩放比例
...
//左侧窗控制器
@property (nonatomic, strong)UIViewController <LeftSideVCtrlProtocol> *leftVC;
 ...
 */
- (instancetype)initWithLeftView:(UIViewController <LeftSideVCtrlProtocol> *)leftVC
